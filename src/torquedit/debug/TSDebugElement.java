 ...
 */
public abstract class TSDebugElement extends PlatformObject implements IDebugElement {
	
	// containing target 
	protected TSDebugTarget fTarget;
	
	/**
	 * Constructs a new debug element contained in the given
	 * debug target.
	 * 
	 * @param target debug target (Torque executable)
	 */
	public TSDebugElement(TSDebugTarget target) {
		fTarget = target;
	}
	...
	protected void abort(String message, Throwable e) throws DebugException {
		throw new DebugException(new Status(IStatus.ERROR, "TS Debug Internal Error", message, e));
	}
